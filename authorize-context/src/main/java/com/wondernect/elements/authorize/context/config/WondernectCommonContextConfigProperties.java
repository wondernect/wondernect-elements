 ...
 * Description: wondernect common context config properties
 */
@Component
@Primary
...
@ConfigurationProperties(prefix = "wondernect.elements.context.common")
public class WondernectCommonContextConfigProperties implements Serializable {
