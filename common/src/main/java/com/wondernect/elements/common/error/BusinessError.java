...
public enum BusinessError {
    ...
    AUTHORIZE_USERID_IS_NULL("AUTHORIZE_USERID_IS_NULL", "头部用户id不能为空"),
    AUTHORIZE_REQUESTID_IS_NULL("AUTHORIZE_REQUESTID_IS_NULL", "头部请求id不能为空"),
    ...
    AUTHORIZE_APP_ACCESS_TYPE_INVALID("AUTHORIZE_APP_ACCESS_TYPE_INVALID", "应用暂无访问权限"),
